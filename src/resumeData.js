    ...
    "portfolio":[
      {
        ...
        "description":"React in Rails (in progress) You are able to create a personal account and sign in using devise. Once signed in, and only signed in, you can create a listing for an apartment which is stored in a local Database.",
        "imgurl":"https://media.giphy.com/media/WscWy0lw7k0kkojUYh/giphy.gif"
      },
      {
        "name":"Tic-Tac-Toe",
        "description":"Created with React. This was a fun game to make to test logic skills, CSS, & HTML and play around with using grid.",
        "imgurl":"https://media.giphy.com/media/U6derfInQGT7XS7IP7/giphy.gif"
      },
      {
        "name":"OmniFood",
        "description":"HTML/CSS/JavaScript... in progress (Udemy class teaching me proper technique into building a responsive website.",
        "imgurl":"https://media.giphy.com/media/llUpux1PKvrVHqUFTn/giphy.gif"
      },
      {
        "name":"Connect Four",
        "description":"Created in React. This was logically challenging for a bootcamp student. The hardest part was finding all of the winning combinations using functional programming to do so.",
